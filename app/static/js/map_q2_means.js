...
function get_min_max_num_total_issues (data) {
    ...
    for (var i in data.features) {
        var num_issues = data.features[i]['properties'][chosen_year];
...
function getInfoHTML(properties_orig) {
    ...
    title.textContent = 'mean completion hours:'

    var income = document.createElement('div');
    income.innerHTML = properties[chosen_year];
    // income.innerHTML = '<b>' + properties[chosen_year] + '</b>'+ ' total issues per 1000';
...
// Alex stuff
var chosen_year = "completion_time_mean_Animal Control";
var data;
var year_history = [];
